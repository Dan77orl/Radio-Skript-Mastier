...
function getRuStrings(): PromptStrings {
  return {
    ...
    emotionInstructions: `МЕТАТЕГИ ЭМОЦИЙ — ОБЯЗАТЕЛЬНО расставь в тексте:\nСтавь 1-2 тега в начало каждого смыслового блока/предложения.`,
...
function getEnStrings(): PromptStrings {
  return {
    ...
    emotionInstructions: `EMOTION META-TAGS — REQUIRED in the text:\nPlace 1-2 tags at the beginning of each meaningful block/sentence.`,
