...
[${assignedVoices[1]?.personaName || assignedVoices[1]?.name}]: [announcer] ЗАГОЛОВОК`;
      ...
      prompt += `\n\nВАЖНО: Каждый выпуск должен быть УНИКАЛЬНЫМ. НЕ повторяй одни и те же институты, университеты, исследования и источники. Используй РАЗНЫЕ научные данные, статистику и примеры в каждом выпуске. Избегай шаблонных фраз и клише. Придумывай свежие факты и неожиданные ракурсы темы.`;
